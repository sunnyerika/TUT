...
//this class reads one TUT and includes Toolbar icons for Edit & Create
//hence mode = read
public class TUTconnFreshView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutconn_fresh_view);
...
//getImg(TempItem);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_edit:
                ...
                Intent intent = new Intent(getApplicationContext(),TUTconnFreshViewEdit.class);
    ...
    public void HttpWebCallConnection(final String PreviousListViewClickedItem, String url){
        ...
        class HttpWebCallFunction extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                pDialog = ProgressDialog.show(TUTconnFreshView.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new TUTconnFreshView.GetHttpResponse(TUTconnFreshView.this).execute();
            }
    ...
    public void getImgHttpUrlConn(final String tutID, String url) {
        class TutGetImage extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                progressDialog2 = ProgressDialog.show(TUTconnFreshView.this, "Loading Data", null, true, true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                Toast.makeText(TUTconnFreshView.this, httpResponseMsg, Toast.LENGTH_LONG).show();
                ...
                new TUTconnFreshView.GetHttpResponseImage(TUTconnFreshView.this).execute();
            }
    ...
    private class GetHttpResponseImage extends AsyncTask<Void, Void, Void>
    {
        ...
        protected void onPostExecute(Void result)
        {
            Toast.makeText(TUTconnFreshView.this, "gethttpresponse done", Toast.LENGTH_LONG).show();
    ...
    private void init() {
        ...
        SliderPagerAdapterFresh sliderPagerAdapter = new SliderPagerAdapterFresh(TUTconnFreshView.this, imgUrlArray, imgTxtArray);
